            ...
            <div class="sidebar-menu">
                ...
                <li class="item" id="profile">
                    <a href="#profile" class="menu-btn">
                        <i class="fas fa-user-circle"></i><span>Khách hàng<i class="fas fa-chevron-down drop-down"></i></span>
                    </a>
                    <div class="sub-menu">
                        <a href="{{ URL::to('/view-customer') }}"><i class="fas fa-image"></i><span>Thông tin khách hàng</span></a>
                        <a href="{{ URL::to('/add-customer') }}"><i class="fas fa-address-card"></i><span>Thêm khách hàng</span></a>
                    </div>
                </li>
                <li class="item" id="messages">
                    <a href="#messages" class="menu-btn">
                        <i class="fas fa-envelope"></i><span>Sản phẩm <i class="fas fa-chevron-down drop-down"></i></span>
                    </a>
                    <div class="sub-menu">
                        <a href="{{ URL::to('/view-product') }}"><i class="fas fa-envelope"></i><span>Xem sản phẩm</span></a>
                        <a href="{{ URL::to('/top-product') }}"><i class="fas fa-envelope-square"></i><span>10 sản phẩm bán chạy</span></a>
                    </div>
                </li>
                <li class="item" id="settings">
                    ...
                    <div class="sub-menu">
                        <a href="{{ URL::to('/view-purchase') }}"><i class="fas fa-lock"></i><span>Xem các đơn hàng</span></a>
                        <a href="{{ URL::to('/filter-purchase') }}"><i class="fas fa-language"></i><span>Lộc đơn hàng</span></a>
                    </div>
                </li>
